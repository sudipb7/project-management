    ...
    <Body className="bg-gray-100 font-sans">
      <Container className="mx-auto px-4 py-8 max-w-xl">
        <Container className="bg-white rounded-lg shadow-lg p-8">
          ...
          <Text className="text-base text-gray-700 mb-4">Hi {sendTo.name},</Text>
          ...
          <Container className="bg-gray-50 rounded-md p-4 mb-6">
            ...
            <Link
              href={inviteLink}
              className="block text-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition-colors duration-200"
            >
              Join Workspace
            </Link>
          </Container>
          ...
          <Text className="text-xs text-blue-500 break-all mb-6">{inviteLink}</Text>
        </Container>
